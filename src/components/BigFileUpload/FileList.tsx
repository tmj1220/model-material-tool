...
const SortableItem = memo(SortableElement<PreviewProps>((props) => <Preview {...props} />))
const SortableContainerBox:any = SortableContainer(({ children }:Record<string, any>) => <div className="big-file-preview-box">{children}</div>)

const FileList: React.FC<FileListProps> = ({
  fileList, setFileList, imgRatio, onRemove, onPreview, needSort, needCheckImgRatio,
}) => {
